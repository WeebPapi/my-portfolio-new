...
const MobileCarousel = ({ images, onSlideChange }: { images: string[], onSlideChange: (index: number) => void }) => {
...
const ProjectViewPage: React.FC = () => {
  ...
  return (
    <Flex style={{ width: "100%", minHeight: "100vh", padding: '1rem' }} vertical align="center">
      {isMobile ? (
      ...
      <motion.div style={{display: 'flex', justifyContent: 'center', alignItems: 'start', margin: '1rem 0'}}>
        <Typography.Text 
          style={{ 
            fontSize: 16, 
            fontWeight: 600, 
      ...
      <Flex vertical justify="center" align="center" style={{ margin: "5vh 0 3vh 0", maxWidth: 900 }}>
        <Typography.Title className="project-view-title" style={{width: '100%'}}>{title}</Typography.Title>
        <Typography.Paragraph className="project-view-description" style={{ fontSize: 18, color: '#6B7280' }}>{desc}</Typography.Paragraph>
        <Flex className="project-view-links" gap={64} style={{ margin: "1rem 0 2rem 0", width: '100%' }}>
